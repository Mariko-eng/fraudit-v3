...
function IncidentBySFIList() {
  ...
  const incidentsQuery = useQuery({
    queryKey: ["incidents", currentPage, sfi], // Include searchParams in the queryKey
    initialData: {},
    queryFn: async () => {
      if (sfi) {
  ...
  const incidentsSearchQuery = useQuery({
    queryKey: ["incidentSearch", searchParams, currentPage, sfi], // Include searchParams in the queryKey
    initialData: {},
    queryFn: async () => {
      if (sfi) {
        return await IncidentService.getIncidents(
  ...
  const handleFilter = useCallback(() => {
    queryClient.refetchQueries({
      queryKey: ["incidentSearch", searchParams, currentPage, sfi],
    });
  }, [queryClient, searchParams, currentPage, sfi]);
  ...
  useEffect(() => {
    ...
    queryClient.refetchQueries({
      queryKey: ["incidents", currentPage, sfi],
    });
  }, [queryClient, currentPage, sfi]); // Specify dependencies as needed
...
export default IncidentBySFIList;
