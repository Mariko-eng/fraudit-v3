...
function UsersByCategoryList() {
  ...
  const usersQuery = useQuery({
    queryKey: ["users", currentPage, category], // Include searchParams in the queryKey
    initialData: {},
    queryFn: async () =>
  ...
  const userSearchQuery = useQuery({
    queryKey: ["userSearch", searchParams, currentPage, category], // Include searchParams in the queryKey
    initialData: {},
    queryFn: async () =>
      await UserService.getUsers(
        {
  ...
  const handleFilter = useCallback(() => {
    queryClient.refetchQueries({
      queryKey: ["userSearch", searchParams, currentPage, category],
    });
  }, [queryClient, searchParams, currentPage, category]);
  ...
  useEffect(() => {
    ...
    queryClient.refetchQueries({
      queryKey: ["users", currentPage, category],
    });
  }, [queryClient, currentPage, category]); // Specify dependencies as needed
...
export default UsersByCategoryList;
