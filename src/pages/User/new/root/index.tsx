...
const NewUserRoot = () => {
  ...
  const registerSuperUserMutation = useMutation({
    mutationFn: async (form: object) =>
      await UserService.registerSuperUser(
        { ...form },
        {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      console.log(values);
      registerSuperUserMutation.mutate(values);
    },
  });
  ...
  return (
    <>
      ...
      {registerSuperUserMutation.isPending && open && (
        <LoadingModal
          open={open}
          setOpen={setOpen}
      ...
      {registerSuperUserMutation.isError && open && (
        <ErrorModal
          open={open}
          setOpen={setOpen}
          errorTitle={registerSuperUserMutation.error.response?.statusText}
          errorMessage={
            registerSuperUserMutation.error.errorMessage ??
            "Something went wrong. Please try again later."
          }
        />
      )}

      {registerSuperUserMutation.isSuccess && open && (
        <SuccessModal
          open={open}
          setOpen={setOpen}
